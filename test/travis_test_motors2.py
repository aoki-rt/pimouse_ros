...
class MotorTest(unittest.TestCase):
    def setUp(self):
        ...
        on = ros.ServiceProxy('/motor_on',Trigger)
        ret = on()
    ...
    def test_put_freq(self):
        ...
        self.file_check("rtmotor_raw_r0",m.right_hz,"wrong right value fron motor_raw")
    ...
    def test_on_off(self):
        ...
        with open("/dev/rtmotoeren0","r") as f:
            data = f.readline()
            self.assertEqual(data,"1\n","wrong value in rtmotoren0 at motor on")
