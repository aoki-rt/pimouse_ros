...
class BuzzerTest(unittest.TestCase):
    ...
    def test_music(self):
        ...
        self.client.sned_goal(goal,feedback_cb=self.feedback_cb)
        ...
        ###preemption###
        self.device_values = []
        self.client.send_goal(gola,feedback_cb=self.feedback_cb)
        self.client.wait_for_result(rospy.Duration.from_sec(0.5)

        self.assertFalse(self.client.get_result(),"stop is request but return true")
